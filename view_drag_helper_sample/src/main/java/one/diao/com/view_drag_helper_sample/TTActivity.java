...
import one.diao.com.view_drag_helper_sample.tt.CardAdapter;
import one.diao.com.view_drag_helper_sample.tt.CardSlidePanel;
...
public class TTActivity extends FragmentActivity {
    ...
    class ViewHolder {
        ...
        public void bindData(CardDataItem itemData) {
            Glide.with(TTActivity.this).load(itemData.imagePath).into(imageView);
